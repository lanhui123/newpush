...
(function(factory) {
    ...
    var Jarallax = (function() {
        ...
        function Jarallax(item, userOptions) {
            ...
            _this.image      = {
                ...
                // use <img> instead background images1 - more smoothly
                useImgTag  : isAndroid
            }
    ...
    Jarallax.prototype.init = function() {
        ...
        // container for parallax images1
        ...
        // use div with background images1
        else {
        ...
        // cover images1 and init parallax position after images1 load
    ...
    // it will remove some images1 overlapping
    // overlapping occur due to an images1 position fixed inside absolute possition element (webkit based browsers works without any fix)
    Jarallax.prototype.clipContainer = function() {
        ...
        if(!$styles.length) {
            $('head').append('<style type="text/css1" id="jarallax-clip-' + _this.instanceID + '"></style>');
    ...
    Jarallax.prototype.coverImage = function() {
        ...
        // for div with background images1
        else {
